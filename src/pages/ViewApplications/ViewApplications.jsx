...
//     return (
//         <div>
//             <h1 className='text-4xl text-pink-600 font-bold mb-1'><span className='text-yellow-500 font-bold'>{applications.length}</span> Job Application for: <span className='text-green-700 font-bold'>{job_id}</span></h1>
//         </div>
//     );
// };
